          ...
          <div class="table-responsive">
            <table class="table table-hover" id="table" width="100%">
              <thead align="center">
                ...
                <th>Jenis Pelapor</th>
                <th>Nama Barang</th>
                <th width="160">Foto Kerusakan</th>
                <th>Lokasi</th>
                <th>Deskripsi</th>>
                <th>Tgl. Lapor</th>
              ...
              <tbody align="center">
                <?php
                $data = query("SELECT * FROM pengaduan WHERE status='Sedang diajukan' ORDER BY id ASC");
                foreach ($data as $d) :
                ?>
                <tr>
                  <td><?= $d['id']; ?></td>
                  ...
                  <td><?= $d['j_pelapor']; ?></td>
                  <td><?= $d['n_barang']; ?></td>
                  <td><img src="../upload_foto/<?= $d['foto_kerusakan']; ?>" width="100%"></td>
                  <td><?= $d['lokasi']; ?></td>
                  <td><?= $d['ket']; ?></td>
                  <td><?= $d['tgl_lapor']; ?></td>
      ...
      <div class="card">
        ...
        <div class="table">
            <table class="table-hover" id="table2" width="100%">
              ...
              <tbody align="center">
                <?php
                $data = query("SELECT * FROM pengaduan WHERE status='Sedang diproses' ORDER BY id DESC");
                foreach ($data as $d) :
                ?>
                <tr>
                <td><?= $d['id']; ?></td>
          ...
          <div class="table">
            <table class="table-hover" id="table3" width="100%">
              ...
              <th>No.</th>
                ...
                <th>Jenis Pelapor</th>
                <th>Nama Barang</th>
                <th width="160">Foto Perbaikan</th>
                <th>Lokasi</th>
                <th>Deskripsi</th>
                <th>Tgl. Lapor</th>
                <th>Tgl. Perbaikan</th>
              ...
              <tbody align="center">
                <?php
                $data = query("SELECT * FROM pengaduan WHERE status='Selesai diproses' ORDER BY id DESC");
                foreach ($data as $d) :
                ?>
                <tr>
                  <td><?= $d['id']; ?></td>
                  ...
                  <td><?= $d['j_pelapor']; ?></td>
                  <td><?= $d['n_barang']; ?></td>
                  <td><img src="../upload_foto/<?= $d['foto_perbaikan']; ?>" width="100%"></td>
                  <td><?= $d['lokasi']; ?></td>
                  <td><?= $d['ket']; ?></td>
                  <td><?= $d['tgl_lapor']; ?></td>
