...
<head>
  ...
  <title>Pengaduan Kerusakan Barang BKN</title>
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/LogoBKN.png" alt="BKN" class="brand-image  elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">Pengaduan Kerusakan</span>
    </a>
