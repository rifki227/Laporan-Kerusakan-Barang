...
<head>
    ...
    <title>Login | Selamat Datang Di Pengaduan Kerusakan Barang</title>
    <!-- icon diskominfo -->
    <link rel="icon" href="../assets/img/LogoBKN.png">
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row content">
            <div class="col-md-6 mb-3">
                <img src="../assets/dist/img/LogoBKN.png" class="img-fluid" alt="login image">
            </div>
            <div class="col-md-6">
                <a class="btn logo" href="../index.php">PUSBANGPEG ASN</a>
                <img src="../assets/dist/img/LogoBKN.png" width="40" height="40">
                <p class="lead">Selamat Datang Di Pengaduan Kerusakan Barang</p>
