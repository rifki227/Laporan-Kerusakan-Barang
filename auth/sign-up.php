...
<head>
    ...
    <title>Sign Up | PUSBANGPEG ASN</title>
    <!-- icon diskominfo -->
    <link rel="icon" href="../assets/dist/img/LogoBKN.png">
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row content">
            <div class="col-md-6 mb-3">
                <img src="../assets/dist/img/LogoBKN.png" class="img-fluid mb-3" alt="login image">
            </div>
            <div class="col-md-6" style="margin-top: -30px;">
                <a class="btn logo" href="../index.php">PUSBANGPEG ASN</a>
                <img src="../assets/dist/img/LogoBKN.png" width="40" height="40">
                <p class="lead">PUSAT PENGEMBANGAN PEGAWAI APARATUL SIPIL NEGARA</p>
