...
CREATE TABLE `pengaduan` (
  ...
  'foto_kerusakan' varchar(500) NOT NULL,
  'foto_perbaikan' varchar(500) NOT NULL,
...
INSERT INTO `pengaduan` (`id`, `n_pelapor`, `j_pelapor`, `d_pelapor`, `n_barang`, 'foto_kerusakan' `ket`, `status`, `ket_petugas`, `tgl_lapor`) VALUES
